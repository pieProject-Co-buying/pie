...
public class ShareServiceDto extends BoardDto {
	 ...
	 //private int personnelMax; // 최대 인원
	 //private int personnelNow; // 현재 인원 private String ip; // ip
	 
	 //private int hit; // 조회수 
	 //private String premium; // 구독회원 작성여부
	 //private String  profileImg; // 프로필 이미지 
	 //private String tag; // 태그
	 //private int priceTotal; // 가격 총합 
	 //private int pricePer; // 인당 가격 
	 //private String[] productImgs; // 게시글 이미지  배열 
